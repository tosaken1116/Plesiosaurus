import "./index.css";
import Xt, { Children as $t, forwardRef as V, useState as Ct } from "react";
...
function Ci() {
  return Wt || (Wt = 1, process.env.NODE_ENV !== "production" && function() {
    var i = Xt, e = Symbol.for("react.element"), n = Symbol.for("react.portal"), s = Symbol.for("react.fragment"), r = Symbol.for("react.strict_mode"), z = Symbol.for("react.profiler"), u = Symbol.for("react.provider"), x = Symbol.for("react.context"), o = Symbol.for("react.forward_ref"), d = Symbol.for("react.suspense"), g = Symbol.for("react.suspense_list"), f = Symbol.for("react.memo"), N = Symbol.for("react.lazy"), D = Symbol.for("react.offscreen"), X = Symbol.iterator, kt = "@@iterator";
    function H(t) {
    ...
    function S(t, a, l) {
      {
        var y = q.ReactDebugCurrentFrame, m = y.getStackAddendum();
        m !== "" && (a += "%s", l = l.concat([m]));
    ...
    function at(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === s || t === z || L || t === r || t === d || t === g || p || t === D || zt || jt || h || typeof t == "object" && t !== null && (t.$$typeof === N || t.$$typeof === f || t.$$typeof === u || t.$$typeof === x || t.$$typeof === o || // This needs to include all possible module reference object
    ...
    function O(t) {
      ...
      if (typeof t == "object")
        switch (t.$$typeof) {
          ...
          case N: {
            var m = t, v = m._payload, k = m._init;
            try {
              return O(k(v));
            } catch {
              return null;
    ...
    var T = Object.assign, $ = 0, Q, G, Y, st, A, F, M;
    function nt() {
    }
    ...
    function Zt() {
      {
        if ($ === 0) {
          Q = console.log, G = console.info, Y = console.warn, st = console.error, A = console.group, F = console.groupCollapsed, M = console.groupEnd;
          var t = {
            configurable: !0,
            enumerable: !0,
            value: nt,
    ...
    var dt = q.ReactCurrentDispatcher, ct;
    function lt(t, a, l) {
      {
        if (ct === void 0)
          try {
...
` + _[C].replace(" at new ", " at ");
        ...
        ut = !1, dt.current = v, Qt(), Error.prepareStackTrace = m;
      }
    ...
    function yt(t, a, l) {
      ...
      if (typeof t == "object")
        switch (t.$$typeof) {
          ...
          case N: {
            var y = t, m = y._payload, v = y._init;
            try {
              return yt(v(m), a, l);
            } catch {
            }
    ...
    var ot = Object.prototype.hasOwnProperty, Et = {}, Ot = q.ReactDebugCurrentFrame;
    function _t(t) {
      if (t) {
    ...
    function ci(t, a, l, y, m) {
      {
        var v, k = {}, _ = null, R = null;
        l !== void 0 && (Nt(l), _ = "" + l), oi(a) && (Nt(a.key), _ = "" + a.key), yi(a) && (R = a.ref, _i(a, m));
        for (v in a)
        ...
        return di(t, _, R, m, y, tt.current, k);
      }
    }
    var xt = q.ReactCurrentOwner, Tt = q.ReactDebugCurrentFrame;
    function K(t) {
      if (t) {
        var a = t._owner, l = yt(t.type, t._source, a ? a.type : null);
    ...
    function qt(t, a) {
      {
        ...
        if (ft(t))
          ...
          if (typeof m == "function" && m !== t.entries)
            for (var v = m.call(t), k; !(k = v.next()).done; )
...
function bi() {
  ...
  function u(x, o, d) {
    var g, f = {}, N = null, D = null;
    d !== void 0 && (N = "" + d), o.key !== void 0 && (N = "" + o.key), o.ref !== void 0 && (D = o.ref);
    for (g in o)
      s.call(o, g) && !z.hasOwnProperty(g) && (f[g] = o[g]);
    if (x && x.defaultProps)
      for (g in o = x.defaultProps, o)
        f[g] === void 0 && (f[g] = o[g]);
    return { $$typeof: e, type: x, key: N, ref: D, props: f, _owner: r.current };
  }
  return et.Fragment = n, et.jsx = u, et.jsxs = u, et;
}
...
var Oi = (i, e, n) => {
  ...
  var e = (n) => {
    ...
    for (var z in r) {
      var u, x = (u = r[z]) !== null && u !== void 0 ? u : i.defaultVariants[z];
      if (x != null) {
        var o = x;
    ...
    for (var [g, f] of i.compoundVariants)
      Oi(g, r, i.defaultVariants) && (s += " " + f);
    return s;
  };
...
const be = ({
  ...
  return /* @__PURE__ */ c.jsxs("span", { className: Mi, children: [
    /* @__PURE__ */ c.jsx("span", { className: w(Gi, z, n), style: r, children: e }),
    i
  ] });
};
function Ki(i, e) {
...
var Hi = (i) => function() {
  for (var e = arguments.length, n = new Array(e), s = 0; s < e; s++)
    n[s] = arguments[s];
  var r = Object.assign({}, ...n.map((o) => o.styles)), z = Object.keys(r), u = z.filter((o) => "mappings" in r[o]), x = (o) => {
    var d = [], g = {}, f = pt({}, o), N = !1;
    for (var D of u) {
      var X = o[D];
      if (X != null) {
        ...
        for (var H of kt.mappings)
          g[H] = X, f[H] == null && delete f[H];
      }
    }
    var q = N ? pt(pt({}, g), f) : o, j = function() {
      var h = q[S], p = r[S];
      try {
        if (p.mappings)
          return "continue";
        ...
        if (process.env.NODE_ENV !== "production") {
          ...
          var O = (F) => typeof F == "string" ? '"'.concat(F, '"') : F, T = (F, M, nt) => {
            throw new A('"'.concat(F, '" has no value ').concat(O(M), ". Possible values are ").concat(Object.keys(nt).map(O).join(", ")));
          };
          if (!p)
...
function ee(i, e) {
  return $t.map(i, (n, s) => /* @__PURE__ */ c.jsxs(c.Fragment, { children: [
    n,
  ...
  ({
    ...
    return /* @__PURE__ */ c.jsx(
      g,
      {
        ...
        ...d,
        style: { "--spacing": `${s}px` },
        children: n ? ee(o, (f) => /* @__PURE__ */ c.jsx(ae, { children: n }, f)) : o
      }
    );
  }
), ae = ({ children: i }) => /* @__PURE__ */ c.jsx(c.Fragment, { children: i });
  ...
  ({
    ...
    return /* @__PURE__ */ c.jsx(
      "div",
      {
        style: z,
        ref: s,
        className: w(se({ orientation: e }), u, i),
        ...r,
        "data-testId": "divider"
      }
    );
...
const Ee = V(
  ...
  ({ className: i, children: e, ...n }, s) => /* @__PURE__ */ c.jsx("span", { className: w(te.center, i), ref: s, ...n, children: e })
);
...
const Re = ({
  ...
  const [u, x] = Ct(e), { style: o, className: d } = W(r ?? {}), g = (f) => {
    x(f.target.value);
  };
  return /* @__PURE__ */ c.jsx("ul", { className: w(oe, n), children: i.map((f, N) => /* @__PURE__ */ c.jsx("li", { children: /* @__PURE__ */ c.jsxs("label", { className: ye({ zoomIn: s }), children: [
    /* @__PURE__ */ c.jsx(
      "input",
      {
        type: "radio",
    ...
    f,
    /* @__PURE__ */ c.jsx("div", { className: le })
  ] }) }, `${N}-${f}`)) });
};
...
const ue = () => {
  ...
  ({ className: i, id: e, customCheckbox: n, animationProps: s, ...r }, z) => {
    const u = (n == null ? void 0 : n.checked) ?? /* @__PURE__ */ c.jsx(Yt, { fill: r.color || "aquamarine", color: "gray" }), x = (n == null ? void 0 : n.unchecked) ?? /* @__PURE__ */ c.jsx(Yt, { color: "gray" }), o = r.onChange ?? ue, [d, g] = Ct(r.checked || !1), { style: f, className: N } = W(
      s ?? {}
    );
    return /* @__PURE__ */ c.jsxs("label", { className: w(N, ze), style: f, children: [
      /* @__PURE__ */ c.jsxs("span", { className: ke, children: [
        d ? /* @__PURE__ */ c.jsxs("span", { className: Jt, children: [
          " ",
          u
        ] }) : /* @__PURE__ */ c.jsxs("span", { className: Jt, children: [
          " ",
          x
        ] }),
        /* @__PURE__ */ c.jsx(
      ...
      /* @__PURE__ */ c.jsx("p", { className: ce, children: r.label })
    ] });
  }
), Pe = V(
  ({
...
var fe = "_1tcidmt0", me = "_1tcidmt1";
const Ae = V(({ className: i }, e) => /* @__PURE__ */ c.jsx("label", { className: w(me, i), htmlFor: "switch", children: /* @__PURE__ */ c.jsx("input", { type: "checkbox", className: fe, ref: e, id: "switch" }) }));
var xe = E({ defaultClassName: "_1nn3gz2", variantClassNames: { close: { true: "_1nn3gz3" }, currentValue: { true: "_1nn3gz4" }, moving: { true: "_1nn3gz5" } }, defaultVariants: {}, compoundVariants: [] }), ge = "_1nn3gz1";
const Ve = V(
  ({ className: i, title: e, defaultValue: n, onChange: s, close: r, moving: z, ...u }, x) => {
    const [o, d] = Ct(n || ""), g = (f) => {
      f.target.value ? d(f.target.value) : d(""), s && s(f);
    };
    return /* @__PURE__ */ c.jsxs("label", { className: w(ge, i), children: [
      e,
      /* @__PURE__ */ c.jsx(
        "input",
        {
          className: xe({ currentValue: !!o, close: r, moving: z }),
          onChange: g,
          ref: x,
          placeholder: "input",
          ...u
...
var ve = E({ defaultClassName: "_11pdv5q1", variantClassNames: { radius: { s: "_11pdv5q2", m: "_11pdv5q3", l: "_11pdv5q4" } }, defaultVariants: {}, compoundVariants: [] });
const De = ({
  className: i,
  width: e,
  height: n,
  ...
  const { style: z, className: u } = W(r ?? {});
  return /* @__PURE__ */ c.jsx(
    "div",
    {
      className: w(ve({ radius: s }), u, i),
